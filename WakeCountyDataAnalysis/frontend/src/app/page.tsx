...
export default function Home() {
  return (
    ...
    <div className='bg-black m-20 rounded-3xl shadow-2xl hover:shadow-red-500'>
    <main className={styles.main}>
      ...
      <span className="text-blue-600 dark:text-blue-500 rainbow-text"> Wake County</span> data.</h1>
